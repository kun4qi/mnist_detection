...
def main(config):
    ...
    G.load_state_dict(torch.load(config.save.output_root_dir + config.save.generator_savename))
    D.load_state_dict(torch.load(config.save.output_root_dir + config.save.discriminator_savename))
